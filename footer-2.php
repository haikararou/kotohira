...
<footer id="footer-wrapper">
    <div class="footer-top">
       	<h2>コトヒラ工業の製品に関する<br />ご相談はお気軽に<br />お問い合わせください。</h2>
        <div class="footer_sec column-flex">
            <div class="footer-topL">
                <div><span class="tel-link">0268-63-0120</span><small>受付時間／平日9:00～17:00</small></div>
            </div>
            <div class="footer-topR">
                <div><a href="<?php echo home_url('/'); ?>contact/products" class="btn"><span class="btn-inner">製品についてのお問い合わせ</span></a></div>
            </div>
        </div>
    </div>
    <nav>
...
<div class="bottom_nav">
    <nav class="column-flex">
        ...
        <a href="tel:0268630120"><em>0268-63-0120</em></a>
    </nav>
</div>
<script>
$(function() {

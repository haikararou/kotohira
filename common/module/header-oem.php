...
<header>
	<div id="header-wrapper">
        ...
        <div class="clearfix panel">
            ...
            <div class="panel_btn">
                <!--<span class="tel-link">0268-63-0001</span>--><a class="tel_js" href="tel:0268630120"><em>0268-63-0120</em></a>
    ...
    <nav id="subNav">
        <ul class="column-flex">
            <li><a href="<?php echo home_url('/'); ?>oem/top/">コトヒラの<br />OEM</a></li>
            <li><a href="<?php echo home_url('/'); ?>oem/flow/">一括受託体制<br />の流れ</a></li>
            <li><a href="<?php echo home_url('/'); ?>oem/facility/">設備</a></li>
            <li><a href="<?php echo home_url('/'); ?>oem/seikan/">大型製缶<br />一貫工場</a></li>

...
<header>
        ...
        <div class="header-inner">
            ...
            <nav id="globalNav">
                <ul>
                    ...
                    <li><a href="<?php echo home_url('/'); ?>company/outline/">COMPANY<span><!--header--><header>	<div id="header-wrapper">        <div id="logo"><a href="<?php echo home_url('/'); ?>">コトヒラ工業株式会社</a></div>        <div class="header-inner">            <!--globalNav-->            <nav id="globalNav">                <ul>                    <li><a href="<?php echo home_url('/'); ?>products/">PRODUCTS<span>自社製品</span></a></li>                    <li><a href="<?php echo home_url('/'); ?>oem/top/">OEM<span>製造受託</span></a></li>                    <li><a href="<?php echo home_url('/'); ?>company/outline/">COMPANY<span>会社情報</span></a></li>
    ...
    <nav id="subNav">
        <ul class="column-flex">
            ...
            <li><a href="<?php echo home_url('/'); ?>recruit/internship/">インターン<br />シップ</a></li>
        </ul>
    </nav>
</header>